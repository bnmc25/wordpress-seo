...
function IndexationView( { setIndexingState } ) {
	...
	>
		...
		>
			...
			<h4 className="yst-mb-2 yst-text-base yst-text-slate-900 yst-font-medium yst-leading-tight">{ __( "No data to show yet", "wordpress-seo" ) }</h4>
			<div className="yst-flex yst-flex-col yst-items-center">
				<p className="yst-slate-500 yst-font-normal yst-leading-normal">
					{ __( "We would like to show you insights into content that we feel could use improving.", "wordpress-seo" ) }
				</p>
				<p className="yst-slate-500 yst-font-normal yst-leading-normal yst-mb-6">
